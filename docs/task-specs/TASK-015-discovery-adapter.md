...
Deliver discovery adapter for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for discovery adapter.
...
Reviewable discovery adapter artifact with explicit status and evidence boundary.
...
Produce structured observations; preserve source hierarchy and status vocabulary.
...
Focused check covers structured observations; main validator and unit tests deferred to validator repair.

## Acceptance Criteria

Structured observations exists as topic-specific reviewable artifact; no VALIDATED claim without required review and evidence.
