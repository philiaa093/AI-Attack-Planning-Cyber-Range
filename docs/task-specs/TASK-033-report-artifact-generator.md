# TASK-033 — Report artifact generator
...
Deliver report artifact generator for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for report artifact generator.
...
Reviewable report artifact generator artifact with explicit status and evidence boundary.
...
Produce traceable figures/tables; preserve source hierarchy and status vocabulary.
...
Focused check covers traceable figures/tables; main validator and unit tests deferred to validator repair.

## Acceptance Criteria

Traceable figures/tables exists as topic-specific reviewable artifact; no VALIDATED claim without required review and evidence.
