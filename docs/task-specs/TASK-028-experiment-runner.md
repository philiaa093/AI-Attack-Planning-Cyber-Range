...
Deliver experiment runner for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for experiment runner.
...
Reviewable experiment runner artifact with explicit status and evidence boundary.
...
Produce same scenario/budget; preserve source hierarchy and status vocabulary.
...
Focused check covers same scenario/budget; main validator and unit tests deferred to validator repair.

## Acceptance Criteria

Same scenario/budget exists as topic-specific reviewable artifact; no VALIDATED claim without required review and evidence.
