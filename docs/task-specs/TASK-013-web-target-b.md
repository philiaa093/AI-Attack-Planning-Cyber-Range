...
Deliver web target b for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for web target b.
...
Reviewable web target b artifact with explicit status and evidence boundary.
...
Produce health/reset; preserve source hierarchy and status vocabulary.
...
Focused check covers health/reset; main validator and unit tests deferred to validator repair.

## Acceptance Criteria

Health/reset exists as topic-specific reviewable artifact; no VALIDATED claim without required review and evidence.
