...
Deliver web target a for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for web target a.
...
Reviewable web target a artifact with explicit status and evidence boundary.
