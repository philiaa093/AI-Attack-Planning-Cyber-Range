...
Deliver planner interface for bounded AI planning in isolated Web Cyber Range.
...
Topic-specific artifact for planner interface.
...
Reviewable planner interface artifact with explicit status and evidence boundary.
...
TASK-004, TASK-005, TASK-019
## Implementation Requirements

Produce shared interface; preserve source hierarchy and status vocabulary.
...
Focused check covers shared interface; main validator and unit tests deferred to validator repair.

## Acceptance Criteria

Shared interface exists as topic-specific reviewable artifact; no VALIDATED claim without required review and evidence.
